...
- (void)layoutSubviews
{
    ...
    self.preButton.center = CGPointMake(40, CGRectGetMidY(self.bounds));
    self.nextButton.center = CGPointMake(CGRectGetMaxX(self.bounds)-40, CGRectGetMidY(self.bounds));
}
...
- (UIButton *)preButton
{
    if (!_preButton) {
        ...
        [_preButton setImage:[UIImage imageNamed:[self videoImageName:@"kr-video-player-left"]] forState:UIControlStateNormal];
        _preButton.bounds = CGRectMake(0, 0, kVideoControlBarHeight, kVideoControlBarHeight);
    }
    return _preButton;
}
...
- (UIButton *)nextButton
{
    if (!_nextButton) {
        ...
        [_nextButton setImage:[UIImage imageNamed:[self videoImageName:@"kr-video-player-right"]] forState:UIControlStateNormal];
